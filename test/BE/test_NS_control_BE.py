...
from tlm_adjoint import garbage_cleanup, DEFAULT_COMM
...
def test_MMS_instationary_Stokes_control_BE_convergence_FE():
    ...
    def force_f_v(test, t):
        ...
        # force function
        f = Function(space)
        f.interpolate(-v_space - lapl_v + grad_p - 1.0 / beta * zeta)
